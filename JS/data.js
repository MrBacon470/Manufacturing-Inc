...
function getDefaultObject() {
    return {
        ...
        manufacturedItems: new Array(7).fill(D(0)),
        manufacturingItem: new Array(7).fill(false),
        manufacturedItemQueue: new Array(7).fill(D(0)),
        manufacturingItemTime: new Array(7).fill(0),
